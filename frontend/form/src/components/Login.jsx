  ...
  <div className="bg-[#fff] w-[480px] flex flex-col rounded-md shadow-2xl">
    ...
    <form action="" autoComplete="on" className="p-6">
      ...
      <div className="relative mb-6">
        ...
        />
        <label
          className={`absolute left-10 text-gray-600 pointer-events-none transition-all duration-200 ${
            focusedInput === "email" || user.email
              ? "top-[-27px] left-4 text-sm text-black  px-1"
              : "top-2"
          }`}
        >
          Email
        ...
        <label
          className={`absolute left-10 text-gray-600 pointer-events-none transition-all duration-200 ${
            focusedInput === "password" || user.password
              ? "top-[-28px] left-5 text-sm text-black px-1"
              : "top-2"
          }`}
        >
          Password
